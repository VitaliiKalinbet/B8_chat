  ...
  render() {
    ...
    return (
        <div className='chatWrapper'>
            ...
            <ChannelPanel users={this.props.users} usersOnline={this.props.usersOnline} channels={this.props.channels} changeCurrentChannel={this.props.changeCurrentChannel} currentChannel={this.props.currentChannel}/>
            </div>
