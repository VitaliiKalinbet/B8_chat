...
class Chat extends Component {
    ...
    sendMessageToChannel=()=> {
        if (this.state.newMessage) {
            ...
            console.log(this.state.currentChannel.messages.map(el => el.messageId === editMess.messageId ? editMess : el))
            ...
            let obj={
                message: editMess,
                currentChannel: this.state.currentChannel._id,
            }
            console.log(obj)
    ...
    //             input: '',
    //             showEmoji: false,
    //             // currentChannel: prev.currentChannel.messages.map(el => el.messageId === editMess.message.messageId ? editMess : el)
    //         }))
  ...
  render() {
      ...
      const {allUsers, currentChannel} = this.props;
      ...
      <div className='container'>
        ...
        <MessageHeader/>
           ...
           <Segment clearing>
                ...
                <Header.Subheader>
                   {currentChannel && currentChannel.channelName} / Online Users: {this.state.online}
                </Header.Subheader>
                </Header>
            </Segment>
